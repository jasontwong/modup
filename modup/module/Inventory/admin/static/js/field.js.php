(function ($) {
    ...
    $(function () {
        ...
        //}}}
        var close_src = '/file/module/Inventory/img/option-close.png',
            close_img = '<img src="' + close_src + '" alt="" />',
            grids = $('input.inventory-grid');
        grids
            .each(function (index) {
                //{{{ init
                var el = $(this),
                ...
                function activate_column_deleters() {
                    $('thead th div.option-deleter', table)
                        .each(function (i) {
                            var el = $(this),
                ...
                function activate_row_deleters() {
                    $('tbody tr', table)
                        .each(function (i) {
                            var el = $(this),
                                deleter = $('> th > div.option-deleter', el);
                ...
                function build_form() {
                    ...
                    var col_select,     // the dropdown with the options
                    ...
                    if (product.x.length && product.y.length) {
                        if (has_options_x && product.x.length) {
                            ...
                            table +=            '<th class="add-column"><a>add<br>another</a></th>' +
                                            '</tr>' +
                                        '</thead>';
                        } 
                        table +=    '<tbody>';
                    ...
                    if (has_options_x) {
                        ...
                        col_select
                            ...
                            .change(function () {
                                var el = $(this),
                                    deleter = $('<div class="option-deleter"><a>' + close_img + '</a></div>'),
                                    cell = $('<th><div class="option-label">' + el.val() + '</div></th>'),
