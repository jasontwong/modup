        ...
        <table>
            ...
            <?php foreach ($items as $k => $item): ?>
                <?php
                    ...
                    $row = array(
                        $item['name'], $item['sku'], $item['color'], $item['size'], '$'.number_format($item['cost'], 2), '$'.number_format($item['price'], 2), $item['qty'],
                    );
                ?>
                <?php if ($color_changed): ?>
                    <tr style="background-color:#EEE;">
                        <td colspan="6" style="padding:5px 0px 5px 3px;">Color Subtotal:</td>
                ...
                <?php if ($name_changed): ?>
                    <tr style="background-color:#CCC;">
                        <td colspan="6" style="padding:5px 0px 5px 3px;">Product Total:</td>
                ...
                <?php if ($last_cat != $item['category']): ?>
                    ...
                    <tr style="background-color:#000;">
                        <td colspan="7" style="color:#FFF;padding:5px 0 5px 3px;font-weight:bold;"><?php echo $item['category']; ?></td>
                    </tr>
                    <tr>
            ...
            <?php endforeach; ?>
                <tr style="background-color:#CCC;">
                    <td colspan="6" style="padding:5px 0px 5px 3px;">Grand Total:</td>
