                    ...
                    <tr>
                        <td>
                            ...
                            <table cellpadding='0' cellspacing='0'>
                                <tr>
                                    ...
                                    <td style='font-size: 10px;'>
                                        ...
                                        <?php echo date('Y-m-d', $order['created_date']) ?>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style='font-size: 10px; color: #939598; line-height: 16px;'>
                                ...
                                <div>
                                    YOUR ORDER HAS BEEN RECEIVED SUCCESSFULLY AND WE'RE IN THE PROCESS
                                    OF PREPARING IT FOR SHIPMENT. ONCE YOUR ITEM(S) LEAVE OUR WAREHOUSE
                                    YOU'LL RECEIVE A SHIPPING CONFIRMATION EMAIL WITH TRACKING 
                                    INFORMATION.
                                </div>
                                <img height='14' width='564' src='<?php echo IMG_DIR ?>/w2.png' alt=''>
                                <div>
                                    YOUR ORDER WILL BE DELIVERED VIA <?php echo strtoupper($order['shipping_label']); ?>
                                </div>
